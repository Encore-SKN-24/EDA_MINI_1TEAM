...
- 서울 지역 : 일반 상업용이 많이 나타났다. 특히 강남, 서초 등과 같이 업무지구가 조성되어 있는 곳이 있어, 전력의 사용 비중이 높았다.
- 경인 지역 : 인천과 경기도 5개 지역의 데이터를 이용했다. 인천과 경기는 주택과 산업이 같이 밀집되어 있다는 점, 또한 인천은 항구 도시이기에 산업용이 높게 나타나는 것을 볼 수 있었다. 
...
- 경상남도 지역 : 남해바다를 접하고 부산이라는 항구도시가 있어, 산업용이 높지만 크게 높은 비율을 보이진 않았다. 
...
- 충청도 지역 : 산업용이 높지만, 다른 지역에 비해 산업용 전력사용량의 평균이 완만하였다.
